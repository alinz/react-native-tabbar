...
export default class App extends Component {
  ...
  //############################################################################
  //this is the part that makes the oriantation work with tabbar
  updateOrientation = () => {
    this.tabarRef.recalculate()
  }

  componentDidMount() {
    Orientation.addListener(this.updateOrientation);
  }

  componentWillUnmount() {
    Orientation.removeListener(this.updateOrientation);
  }
  //############################################################################
